...
class PushManifestingListScreen extends Component {
    constructor(props) {
        super(props)
        this.state={
            since: dateNow,
                    ...
                    <ScrollView horizontal={true}>
                        <View style={{ justifyContent: 'flex-start' }}>
                            <View style={styles.tableContainer}>
                                ...
                                <View style={styles.tableContent}>
                                    <Text style={styles.tableHeader}>Returning : </Text>
                                </View>                               
                            </View>
                            ...
                            <FlatList
                                ...
                                renderItem={({ item }) => 
                                    <TouchableOpacity onPress={() => {
                                         ...
                                         this.props.manifestingPush(this.props.token, item.key, item.number, item.trxtype, item.instance,item.repocount, item.requested, item.requestedby,item.requestedbyNIK,item.approved,item.approvedby,item.approvedbyNIK,item.accepted,item.acceptedby,item.acceptedbyNIK,item.returning);
                                        ...
                                        <View style={styles.tableContainer}>
                                            ...
                                            <View style={styles.tableContent} >
                                                <Text>{item.returning.toString()}</Text>
                                            </View>                                          
                                        </View>
...
const mapDispatchToProps = (dispatch) => {
    return {
        manifestingPush: (token, key, number, trxtype, instance,repocount, requested, requestedby,requestedbyNIK,approved,approvedby,approvedbyNIK,accepted,acceptedby,acceptedbyNIK,returning) => {
            dispatch(manifestingPush(token, key, number, trxtype, instance,repocount, requested, requestedby,requestedbyNIK,approved,approvedby,approvedbyNIK,accepted,acceptedby,acceptedbyNIK,returning))
        }
    };
}

export default connect(mapStateToProps,mapDispatchToProps)(PushManifestingListScreen);