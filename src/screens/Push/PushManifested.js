...
class PushManifestedScreen extends Component {
    constructor(props) {
        super(props)
        this.state = {
            since: dateNow,
            ...
            <View style={styles.container}>
                            ...
                            <FlatList
                                ...
                                renderItem={({ item }) =>
                                    <TouchableOpacity onPress={() => {
                                        ...
                                        this.props.manifestedPush(this.props.token, this.props.pushKey, item.key, this.props.returning);
                ...
                <ActionButton buttonColor="rgba(231,76,60,1)">
                    <ActionButton.Item buttonColor='#9b59b6' title="Add Manifest" onPress={() => {
                        this.props.manifestedPush(this.props.token, this.props.pushKey, '', this.props.returning);
...
const mapStateToProps = (state) => {
    return {
        ...
        returning: state.reducerPush.returning,
        number: state.reducerPush.number,
    };
}
const mapDispatchToProps = (dispatch) => {
    return {
        manifestedPush: (token, pushkey, repoID, returning) => {
            dispatch(manifestedPush(token, pushkey, repoID, returning))
        },
    };
}

export default connect(mapStateToProps, mapDispatchToProps)(PushManifestedScreen);