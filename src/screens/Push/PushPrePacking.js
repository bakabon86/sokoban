...
class PushPrePackingScreen extends Component {
    constructor(props) {
        super(props)
        this.state = {
            pushKey: '',
    ...
    getQR() {
        var url = connection.SERVER + 'push/PrePacking?token=' + this.props.token +
                    '&pushkey=' + this.props.pushKey + '&PIN=' + this.state.pin
            ...
            <ScrollView style={styles.container}>
                <ContainerView>
                    ...
                    <ButtonContainer>
                        ...
                        <Button text="Back" onPress={() => { this.props.navigation.navigate('PushPackingList') }} />
                    </ButtonContainer>
                </ContainerView>
            </ScrollView>
        );
...
export default connect(mapStateToProps)(PushPrePackingScreen);