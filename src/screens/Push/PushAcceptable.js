...
class PushAcceptableScreen extends Component {
    constructor(props) {
        super(props)
        this.state = {
            pushKey: '',
    ...
    Acceptable() {
        var url = connection.SERVER + 'trx/accept'
        //var url = 'http://192.168.33.48:5006/push/Acc'
        console.log("URL=" + url)
        ...
        console.log('formData=' + this.props.token + this.props.pushAccKey + this.state.approved + this.state.reason)
            ...
            fetch(url, config)
                ...
                .then((responseJson) => {
                    if (responseJson.status === true) {
                        ...
                        this.props.navigation.navigate("PushAcceptableList");
                    }
                    else {
        ...
        return (
            <ScrollView style={styles.container}>
                <ContainerView>
                    ...
                    <ButtonContainer>
                        <Button text="Save" onPress={() => { this.Acceptable() }} />
                        <Button text="Cancel" onPress={() => { this.props.navigation.navigate('PushAcceptableList') }} />
                    </ButtonContainer>
                </ContainerView>
            </ScrollView>
        );
...
export default connect(mapStateToProps)(PushAcceptableScreen);