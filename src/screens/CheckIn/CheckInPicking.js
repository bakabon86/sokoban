...
class CheckInPickingScreen extends Component {
    constructor(props) {
        super(props)
        this.state = {
           secretKey: '',
    ...
    PickingInit() {
        var url = connection.SERVER + 'checkin/pick/init'
        ...
        console.log('formData=' + this.props.token + ' key=' + this.props.pullKey)
            ...
            fetch(url, config)
                ...
                .then((responseJson) => {
                    if (responseJson.status === true) {
                        ...
                        //this.props.sealedPush(this.props.token, this.state.secretKey,'picking');
                        this.props.dropInit(this.props.token, this.props.pullKey ,this.state.secretKey,'pick')
    ...
    Picking(){
        var url = connection.SERVER + 'checkin/pick'
        console.log("URL=" + url)
        var formData = new FormData();
        ...
        return (
            <ScrollView style={styles.container}>
                <ContainerView>
                    ...
                    <ButtonContainer>
                        <Button text="Pick" onPress={() => { this.PickingInit() }} />
                        <Button text="Cancel" onPress={() => { this.props.navigation.navigate('CheckInPickingList') }} />
                    </ButtonContainer>
                </ContainerView>
            </ScrollView>
        );
...
export default connect(mapStateToProps, mapDispatchToProps)(CheckInPickingScreen);