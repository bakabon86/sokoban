...
import { unsealedPull,dropPull } from '../../actions/pull';
...
class CheckInRestoringListScreen extends Component {
    constructor(props) {
        super(props)
        this.state = {
    ...
    getCheckInRestorableList() {
        //var url = connection.SERVER + 'register/apprlist?token=' + this.props.token
        var url = connection.SERVER + 'checkin/list/restorable?token=' + this.props.token
        console.log("URL=" + url)
        const config = {
            method: 'POST',
            headers: {
                        ...
                        <FlatList
                            ...
                            renderItem={({ item }) => //<View style={{ flex: 1, flexDirection: 'row',justifyContent:'flex-start' }}>
                                <TouchableOpacity onPress={() => {
                                    ...
                                    this.props.navigation.navigate("CheckInRestoring", { key: item.key });
                                }}>
                                    <View style={styles.tableContainer}>
                                        {/* <View style={styles.tableContent}>
                                            <Text>{item.key} </Text>
...
export default connect(mapStateToProps, mapDispatchToProps)(CheckInRestoringListScreen);