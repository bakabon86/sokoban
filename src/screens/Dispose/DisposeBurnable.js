...
class DisposeBurn extends Component {
    constructor(props) {
        super(props)
        this.state = {
           secretKey: '',
    ...
    BurnInit() {
        var url = connection.SERVER + 'dispose/burn/init'
        ...
        console.log('checkinkey=' + this.props.pullKey);
            ...
            fetch(url, config)
                ...
                .then((responseJson) => {
                    if (responseJson.status === true) {
                        ...
                        //this.props.sealedPush(this.props.token, this.state.secretKey,'drop');
                        this.props.dropInit(this.props.token, this.props.pullKey ,this.state.secretKey,'burn')
        ...
        return (
            <ScrollView style={styles.container}>
                <ContainerView>
                    ...
                    <ButtonContainer>
                        <Button text="Burn" onPress={() => { this.BurnInit() }} />
                        <Button text="Cancel" onPress={() => { this.props.navigation.navigate('DisposeBurnableList') }} />
                    </ButtonContainer>
                </ContainerView>
            </ScrollView>
        );
...
export default connect(mapStateToProps, mapDispatchToProps)(DisposeBurn);