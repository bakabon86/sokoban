...
class formDisposeScreen extends Component {
    constructor(props) {
        super(props)
    ...
    saveDispose() {
        ...
        var url = connection.SERVER + "dispose/req"
        //var url = "http://192.168.23.105:5005/dispose/req"
        ...
        fetch(url, config)
            ...
            .then((responseJson) => {
                if (responseJson.status === true) {
                    ...
                    alert("Dispose has been Requested");
        ...
        return (
            <ScrollView style={styles.container}>
                <ContainerView>
                    ...
                    />
                    <ButtonContainer>
                        <Button text="Send" onPress={() => this.saveDispose()} />
...
export default connect(mapStateToProps)(formDisposeScreen);