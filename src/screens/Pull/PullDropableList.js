...
class PullDropableListScreen extends Component {
    constructor(props) {
        super(props)
        this.state = {
            dsPullDropableList: [],
    ...
    getDropableList() {
        ...
        var url = connection.SERVER + 'pull/list/droppable?token=' + this.props.token
        console.log("URL=" + url)
        const config = {
            method: 'POST',
            headers: {
                        ...
                        <FlatList
                            ...
                            renderItem={({ item }) => //<View style={{ flex: 1, flexDirection: 'row',justifyContent:'flex-start' }}>
                                <TouchableOpacity onPress={() => {
                                    ...
                                    this.props.navigation.navigate("PullDropable", { key: item.key });
                                }}>
                                    <View style={styles.tableContainer}>
                                        {/* <View style={styles.tableContent}>
                                            <Text>{item.key} </Text>
...
export default connect(mapStateToProps, mapDispatchToProps)(PullDropableListScreen);