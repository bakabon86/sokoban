            ...
            <ScrollView style={styles.container}>
                <ContainerView>
                    ...
                    <TextInput style={styles.labelDefaultText} editable={false}
                     ...
                     <Text style={styles.labelText}>Dropped :</Text>
                    <TextInput style={styles.labelDefaultText} editable={false}
                        value={this.props.dropped} />  
                    <Text style={styles.labelText}>Dropped By :</Text>
                    <TextInput style={styles.labelDefaultText} editable={false}
                        value={this.props.droppedby} />  
                    <Text style={styles.labelText}>Dropped By NIK :</Text>
                    <TextInput style={styles.labelDefaultText} editable={false}
                        value={this.props.droppedbyNIK} />  
...
const mapStateToProps = (state) => {
    return {
        ...
        dropped: state.reducerPull.dropped,
        droppedby: state.reducerPull.droppedby,
        droppedbyNIK: state.reducerPull.droppedbyNIK,
    };
}
