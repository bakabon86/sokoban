...
class VerificationCounterPartScreen extends Component {
    constructor(props) {
        super(props)
        this.state = {
            passkey: '',
    ...
    Continue() {
        ...
        this.props.navigation.navigate("TwoWayVerificationCounterpart");
    }
            ...
            <ScrollView style={styles.container}>
                <ContainerView>
                   ...
                   <ButtonContainer>
                        ...
                        <Button text="Reject" onPress={() => { this.abortPacking() }} />
...
export default connect(mapStateToProps, mapDispatchToProps)(VerificationCounterPartScreen);